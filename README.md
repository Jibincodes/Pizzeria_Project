...
> 🚧:The connection between menu and user should be deleted and also add the attribute finalprice to Payment. //done already, delete the comment later. ADD role to the user!
